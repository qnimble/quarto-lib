...
extern "C" {
#else
	void enableInterruptTrigger1(trigger_edge_t rising_edge, void (*cb_function)(void), unsigned int priority);
	void enableInterruptTrigger2(trigger_edge_t rising_edge, void (*cb_function)(void), unsigned int priority);
	void enableInterruptTrigger(uint8_t pin, trigger_edge_t edge, void (*cb_function)(void), unsigned int priority);
#endif
